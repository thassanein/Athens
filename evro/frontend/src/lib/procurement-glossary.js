...
export const EXPRESSIONS = [
  ...
  { term: 'Annual impact', definition: 'The per-year value of a saving — one 12-month run-rate. Every headline figure across EVRO Procurement is an annual impact, so a dollar means the same thing on every screen.', example: '$12.34M/yr of annual impact under management.' },
